...
发布tag支持三段语义化版本或四段Windows版本，例如`v1.5.0`或`v1.4.2026.718`。推送tag后，GitHub Actions会将tag版本注入应用显示版本和ProductVersion，生成同版本ZIP，并自动创建GitHub Release；Release同时包含EXE和ZIP。三段tag的Windows FileVersion会按平台要求补零，例如`v1.5.0`对应`1.5.0.0`。
